...
import com.rhuarhri.rickandmortyapp.utils.InjectorUtils
import com.rhuarhri.rickandmortyapp.view.widgets.Alerts
import com.rhuarhri.rickandmortyapp.view.widgets.WidgetBuilder
...
class MainActivity : AppCompatActivity() {
        ...
        MaterialTheme() {
            ...
            Scaffold(
                ...
                Column(Modifier.fillMaxHeight()) {
                    ...
                    widgetBuilder.userAnswer.widget()
                    //alert
    ...
    fun title() {
        ConstraintLayout(Modifier.fillMaxWidth())
        {
            ...
            MaterialTheme() {
                val textStyle = if (widgetBuilder.isScreenSmall) MaterialTheme.typography.h6 else MaterialTheme.typography.h5
                Text(text = "Rick and morty dead or alive",
                        style = textStyle,
                        modifier = titleMod)
